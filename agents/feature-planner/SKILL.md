...
Use feature-plan-template.md to generate: `docs/plans/PLAN_<feature-name>.md`
...
- [feature-plan-template.md](feature-plan-template.md) - Complete plan document template
