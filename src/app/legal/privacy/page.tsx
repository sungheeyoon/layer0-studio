  ...
  return (
    <main className="min-h-screen blueprint-grid flex flex-col items-center justify-center px-8">
      <div className="w-full max-w-[640px] py-24">
        ...
        <h1 className="font-headline text-4xl font-thin tracking-tight text-zinc-900 mb-2">PRIVACY_POLICY</h1>
        <p className="font-body text-xs font-light tracking-wider text-zinc-400 mb-16">LAYER0 STUDIO — DATA & PRIVACY</p>
