...
export default function HeroSection({ section }: ThemeSectionProps) {
  ...
  const description = data['description']?.value || '14년의 노하우를 가진 전문 트레이너가 당신만의 목표를 현실로 만들어 드립니다. 첫 체험은 완전 무료입니다.';
  const bgImage = data['backgroundImage']?.value || 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?auto=format&fit=crop&w=1600&q=80';
