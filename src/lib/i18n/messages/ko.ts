...
export const ko = {
  ...
  dashboard: {
    ...
    projects: {
      ...
      primaryDomain: '공개 주소',
      domainPlaceholder: 'URL 슬러그 입력...',
      verify: '확인',
      verifying: '확인 중...',
      domainSet: '사이트 주소가 설정되었습니다.',
      domainHintPrefix: '게시 주소: ',
      executionStatus: '게시 상태',
      productionState: '게시 상태',
      statusPublishedDesc: '현재 게시되어 전 세계에서 접근 가능합니다.',
      statusDraftDesc: '비공개 상태입니다. 방문자에겐 페이지가 표시되지 않지만, 사이트 주소는 그대로 예약되며 언제든 다시 게시할 수 있습니다.',
      suspend: '게시 중단',
      publish: '게시',
      processing: '처리 중...',
      ...
      deleteWarn: '이 프로젝트와 모든 데이터를 영구 삭제합니다. 되돌릴 수 없으며, 사이트 주소가 해제되어 다른 사용자가 사용할 수 있게 됩니다.',
    ...
    domains: {
      title: '사이트 주소 관리',
      description: '게시한 사이트의 공개 주소를 관리합니다.',
  ...
  editor: {
    ...
    published: {
      line1: '게시되었습니다!',
      setDomainLink: '프로젝트 설정에서 사이트 주소를 설정',
      line2: '하면 공개됩니다.',
      viewSite: '게시된 사이트 보기',
    },
    preview: {
