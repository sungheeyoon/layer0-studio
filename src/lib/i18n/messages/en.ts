...
export const en: Messages = {
  ...
  dashboard: {
    ...
    projects: {
      ...
      statusDraftDesc: 'Unpublished. Visitors cannot see the page, but the domain stays reserved and you can publish again anytime.',
      ...
      deleteWarn: 'Permanently delete this project and all its data. This cannot be undone, and the connected domain is released so another user can claim it.',
